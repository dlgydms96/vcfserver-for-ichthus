...
#ifndef PROTOBUF_umsg_2eproto_INCLUDED
#define PROTOBUF_umsg_2eproto_INCLUDED
...
void AddDescriptors();
void InitDefaultsInitial_msg_CmdImpl();
void InitDefaultsInitial_msg_Cmd();
void InitDefaultsInitial_msg_PrmImpl();
void InitDefaultsInitial_msg_Prm();
void InitDefaultsInitial_msgImpl();
void InitDefaultsInitial_msg();
void InitDefaultsOperational_msgImpl();
void InitDefaultsOperational_msg();
inline void InitDefaults() {
  InitDefaultsInitial_msg_Cmd();
  InitDefaultsInitial_msg_Prm();
  InitDefaultsInitial_msg();
  InitDefaultsOperational_msg();
}
}  // namespace protobuf_umsg_2eproto
namespace vcf {
class Initial_msg;
...
namespace google {
namespace protobuf {
template<> ::vcf::Initial_msg* Arena::Create< ::vcf::Initial_msg>(Arena*);
template<> ::vcf::Initial_msg_Cmd* Arena::Create< ::vcf::Initial_msg_Cmd>(Arena*);
template<> ::vcf::Initial_msg_Prm* Arena::Create< ::vcf::Initial_msg_Prm>(Arena*);
template<> ::vcf::Operational_msg* Arena::Create< ::vcf::Operational_msg>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace vcf {
...
class Initial_msg_Cmd : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:vcf.Initial_msg.Cmd) */ {
 public:
  ...
  inline Initial_msg_Cmd* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Initial_msg_Cmd>(NULL);
  }

  Initial_msg_Cmd* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Initial_msg_Cmd>(arena);
  }
  ...
  // uint32 _varid = 3;
  void clear__varid();
  static const int kVaridFieldNumber = 3;
  ::google::protobuf::uint32 _varid() const;
  void set__varid(::google::protobuf::uint32 value);
 ...
 private:
  ...
  ::google::protobuf::uint32 _varid_;
  ::google::protobuf::int32 _value_;
  mutable int _cached_size_;
  friend struct ::protobuf_umsg_2eproto::TableStruct;
  friend void ::protobuf_umsg_2eproto::InitDefaultsInitial_msg_CmdImpl();
};
// -------------------------------------------------------------------
...
class Initial_msg_Prm : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:vcf.Initial_msg.Prm) */ {
 public:
  ...
  inline Initial_msg_Prm* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Initial_msg_Prm>(NULL);
  }

  Initial_msg_Prm* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Initial_msg_Prm>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_umsg_2eproto::TableStruct;
  friend void ::protobuf_umsg_2eproto::InitDefaultsInitial_msg_PrmImpl();
};
// -------------------------------------------------------------------
...
class Initial_msg : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:vcf.Initial_msg) */ {
 public:
  ...
  inline Initial_msg* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Initial_msg>(NULL);
  }

  Initial_msg* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Initial_msg>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_umsg_2eproto::TableStruct;
  friend void ::protobuf_umsg_2eproto::InitDefaultsInitial_msgImpl();
};
// -------------------------------------------------------------------
...
class Operational_msg : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:vcf.Operational_msg) */ {
 public:
  ...
  inline Operational_msg* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Operational_msg>(NULL);
  }

  Operational_msg* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Operational_msg>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  ...
  // uint32 _varID = 4;
  void clear__varid();
  static const int kVarIDFieldNumber = 4;
  ::google::protobuf::uint32 _varid() const;
  void set__varid(::google::protobuf::uint32 value);
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_umsg_2eproto::TableStruct;
  friend void ::protobuf_umsg_2eproto::InitDefaultsOperational_msgImpl();
};
// ===================================================================
...
// uint32 _varid = 3;
inline void Initial_msg_Cmd::clear__varid() {
  _varid_ = 0u;
}
inline ::google::protobuf::uint32 Initial_msg_Cmd::_varid() const {
  // @@protoc_insertion_point(field_get:vcf.Initial_msg.Cmd._varid)
  return _varid_;
}
inline void Initial_msg_Cmd::set__varid(::google::protobuf::uint32 value) {
  
  _varid_ = value;
  // @@protoc_insertion_point(field_set:vcf.Initial_msg.Cmd._varid)
}
...
// uint32 _varID = 4;
inline void Operational_msg::clear__varid() {
  _varid_ = 0u;
}
inline ::google::protobuf::uint32 Operational_msg::_varid() const {
  // @@protoc_insertion_point(field_get:vcf.Operational_msg._varID)
  return _varid_;
}
inline void Operational_msg::set__varid(::google::protobuf::uint32 value) {
  
  _varid_ = value;
  // @@protoc_insertion_point(field_set:vcf.Operational_msg._varID)
}
...
#endif  // PROTOBUF_umsg_2eproto_INCLUDED
